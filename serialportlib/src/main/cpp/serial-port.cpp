...
Java_com_pemt_serialportlib_SerialPort_open
        (JNIEnv *env, jobject thiz, jstring path, jint baudrate,jint parity, jint dataBits, jint stopBit, jint flags)
{
    int fd;
    speed_t speed;
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_pemt_serialportlib_SerialPort_close
